...
angular.module('owm.resource', [
  ...
  .config(function config($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('new_renter', {
      ...
      views: {
        'main-full@': {
          ...
          templateUrl: 'resource/new_renter/create-booking.tpl.html'
        }
      },
      resolve: {
    ...
    $stateProvider.state('new_renter-create_booking', {
      ...
      templateUrl: 'resource/new_renter/register-person.tpl.html'
    });
    ...
    $stateProvider.state('new_renter-betaal_borg', {
      ...
      templateUrl: 'resource/new_renter/borg.tpl.html',
    });
    ...
    $stateProvider.state('new_renter-bookresource', {
      ...
      templateUrl: 'resource/new_renter/booking.tpl.html',
      resolve: {
